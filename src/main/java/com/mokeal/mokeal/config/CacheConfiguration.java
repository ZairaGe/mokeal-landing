package com.mokeal.mokeal.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.mokeal.mokeal.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.mokeal.mokeal.repository.UserRepository.USERS_BY_EMAIL_CACHE);
