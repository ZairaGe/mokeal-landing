...
const requireRestSample: RestFactura = {
  ...
  fechaEmision: sampleWithRequiredData.fechaEmision?.format(DATE_FORMAT),
...
describe('Factura Service', () => {
  ...
  describe('Service methods', () => {
    ...
    it('should create a Factura', () => {
      ...
      service.create(factura).subscribe(resp => (expectedResult = resp));
    ...
    it('should update a Factura', () => {
      ...
      service.update(factura).subscribe(resp => (expectedResult = resp));
    ...
    describe('addFacturaToCollectionIfMissing', () => {
      it('should add a Factura to an empty array', () => {
        ...
        expect(expectedResult).toEqual([factura]);
      });
      ...
      it('should accept varargs', () => {
        ...
        expect(expectedResult).toEqual([factura, factura2]);
      });
