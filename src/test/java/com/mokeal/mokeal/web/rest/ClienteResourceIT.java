...
import static com.mokeal.mokeal.domain.ClienteAsserts.*;
...
import com.mokeal.mokeal.repository.ClienteRepository;
import com.mokeal.mokeal.service.dto.ClienteDTO;
import com.mokeal.mokeal.service.mapper.ClienteMapper;
...
class ClienteResourceIT {
    ...
    private static final String DEFAULT_NIF_CIF = "AAAAAAAAAA";
    private static final String UPDATED_NIF_CIF = "BBBBBBBBBB";
    ...
    void getAllClientes() throws Exception {
        ...
        restClienteMockMvc
            ...
            .andExpect(jsonPath("$.[*].nifCif").value(hasItem(DEFAULT_NIF_CIF)))
    ...
    void getCliente() throws Exception {
        ...
        restClienteMockMvc
            ...
            .andExpect(jsonPath("$.nifCif").value(DEFAULT_NIF_CIF))
    ...
    @Test
    @Transactional
    void getAllClientesByNifCifIsEqualToSomething() throws Exception {
        // Initialize the database
        insertedCliente = clienteRepository.saveAndFlush(cliente);

        // Get all the clienteList where nifCif equals to
        defaultClienteFiltering("nifCif.equals=" + DEFAULT_NIF_CIF, "nifCif.equals=" + UPDATED_NIF_CIF);
    }

    @Test
    @Transactional
    void getAllClientesByNifCifIsInShouldWork() throws Exception {
        // Initialize the database
        insertedCliente = clienteRepository.saveAndFlush(cliente);

        // Get all the clienteList where nifCif in
        defaultClienteFiltering("nifCif.in=" + DEFAULT_NIF_CIF + "," + UPDATED_NIF_CIF, "nifCif.in=" + UPDATED_NIF_CIF);
    }

    @Test
    @Transactional
    void getAllClientesByNifCifIsNullOrNotNull() throws Exception {
        // Initialize the database
        insertedCliente = clienteRepository.saveAndFlush(cliente);

        // Get all the clienteList where nifCif is not null
        defaultClienteFiltering("nifCif.specified=true", "nifCif.specified=false");
    }

    @Test
    @Transactional
    void getAllClientesByNifCifContainsSomething() throws Exception {
        // Initialize the database
        insertedCliente = clienteRepository.saveAndFlush(cliente);

        // Get all the clienteList where nifCif contains
        defaultClienteFiltering("nifCif.contains=" + DEFAULT_NIF_CIF, "nifCif.contains=" + UPDATED_NIF_CIF);
    }

    @Test
    @Transactional
    void getAllClientesByNifCifNotContainsSomething() throws Exception {
        // Initialize the database
        insertedCliente = clienteRepository.saveAndFlush(cliente);

        // Get all the clienteList where nifCif does not contain
        defaultClienteFiltering("nifCif.doesNotContain=" + UPDATED_NIF_CIF, "nifCif.doesNotContain=" + DEFAULT_NIF_CIF);
    }
    ...
    void getAllClientesByMunicipioIsEqualToSomething() throws Exception {
        ...
        // Get all the clienteList where municipio equals to
        defaultClienteFiltering("municipio.equals=" + DEFAULT_MUNICIPIO, "municipio.equals=" + UPDATED_MUNICIPIO);
    }

    @Test
    @Transactional
    void getAllClientesByMunicipioIsInShouldWork() throws Exception {
        // Initialize the database
        insertedCliente = clienteRepository.saveAndFlush(cliente);

        // Get all the clienteList where municipio in
        defaultClienteFiltering("municipio.in=" + DEFAULT_MUNICIPIO + "," + UPDATED_MUNICIPIO, "municipio.in=" + UPDATED_MUNICIPIO);
    }

    @Test
    @Transactional
    void getAllClientesByMunicipioIsNullOrNotNull() throws Exception {
        // Initialize the database
        insertedCliente = clienteRepository.saveAndFlush(cliente);

        // Get all the clienteList where municipio is not null
        defaultClienteFiltering("municipio.specified=true", "municipio.specified=false");
    }

    @Test
    @Transactional
    void getAllClientesByMunicipioContainsSomething() throws Exception {
        // Initialize the database
        insertedCliente = clienteRepository.saveAndFlush(cliente);

        // Get all the clienteList where municipio contains
        defaultClienteFiltering("municipio.contains=" + DEFAULT_MUNICIPIO, "municipio.contains=" + UPDATED_MUNICIPIO);
    }

    @Test
    @Transactional
    void getAllClientesByMunicipioNotContainsSomething() throws Exception {
        // Initialize the database
        insertedCliente = clienteRepository.saveAndFlush(cliente);

        // Get all the clienteList where municipio does not contain
        defaultClienteFiltering("municipio.doesNotContain=" + UPDATED_MUNICIPIO, "municipio.doesNotContain=" + DEFAULT_MUNICIPIO);
    }

    @Test
    @Transactional
    void getAllClientesByCodigoPostalIsEqualToSomething() throws Exception {
        // Initialize the database
        insertedCliente = clienteRepository.saveAndFlush(cliente);

        // Get all the clienteList where codigoPostal equals to
        defaultClienteFiltering("codigoPostal.equals=" + DEFAULT_CODIGO_POSTAL, "codigoPostal.equals=" + UPDATED_CODIGO_POSTAL);
    }

    @Test
    @Transactional
    void getAllClientesByCodigoPostalIsInShouldWork() throws Exception {
        // Initialize the database
        insertedCliente = clienteRepository.saveAndFlush(cliente);

        // Get all the clienteList where codigoPostal in
    ...
    @Test
    @Transactional
    void getAllClientesByCodigoPostalIsNullOrNotNull() throws Exception {
        // Initialize the database
        insertedCliente = clienteRepository.saveAndFlush(cliente);

        // Get all the clienteList where codigoPostal is not null
        defaultClienteFiltering("codigoPostal.specified=true", "codigoPostal.specified=false");
    }

    @Test
    @Transactional
    void getAllClientesByCodigoPostalContainsSomething() throws Exception {
        // Initialize the database
        insertedCliente = clienteRepository.saveAndFlush(cliente);

        // Get all the clienteList where codigoPostal contains
        defaultClienteFiltering("codigoPostal.contains=" + DEFAULT_CODIGO_POSTAL, "codigoPostal.contains=" + UPDATED_CODIGO_POSTAL);
    }

    @Test
    @Transactional
    void getAllClientesByCodigoPostalNotContainsSomething() throws Exception {
        // Initialize the database
        insertedCliente = clienteRepository.saveAndFlush(cliente);

        // Get all the clienteList where codigoPostal does not contain
        defaultClienteFiltering(
    ...
    @Test
    @Transactional
    void getAllClientesByNotasIsEqualToSomething() throws Exception {
        // Initialize the database
        insertedCliente = clienteRepository.saveAndFlush(cliente);

        // Get all the clienteList where notas equals to
        defaultClienteFiltering("notas.equals=" + DEFAULT_NOTAS, "notas.equals=" + UPDATED_NOTAS);
    }

    @Test
    @Transactional
    void getAllClientesByNotasIsInShouldWork() throws Exception {
        // Initialize the database
        insertedCliente = clienteRepository.saveAndFlush(cliente);

        // Get all the clienteList where notas in
        defaultClienteFiltering("notas.in=" + DEFAULT_NOTAS + "," + UPDATED_NOTAS, "notas.in=" + UPDATED_NOTAS);
    }

    @Test
    @Transactional
    void getAllClientesByNotasIsNullOrNotNull() throws Exception {
        // Initialize the database
        insertedCliente = clienteRepository.saveAndFlush(cliente);

        // Get all the clienteList where notas is not null
        defaultClienteFiltering("notas.specified=true", "notas.specified=false");
    }

    @Test
    @Transactional
    void getAllClientesByNotasContainsSomething() throws Exception {
        // Initialize the database
        insertedCliente = clienteRepository.saveAndFlush(cliente);

        // Get all the clienteList where notas contains
        defaultClienteFiltering("notas.contains=" + DEFAULT_NOTAS, "notas.contains=" + UPDATED_NOTAS);
    }

    @Test
    @Transactional
    void getAllClientesByNotasNotContainsSomething() throws Exception {
        // Initialize the database
        insertedCliente = clienteRepository.saveAndFlush(cliente);

        // Get all the clienteList where notas does not contain
        defaultClienteFiltering("notas.doesNotContain=" + UPDATED_NOTAS, "notas.doesNotContain=" + DEFAULT_NOTAS);
    }
    ...
    void partialUpdateClienteWithPatch() throws Exception {
        ...
        partialUpdatedCliente.municipio(UPDATED_MUNICIPIO).codigoPostal(UPDATED_CODIGO_POSTAL).notas(UPDATED_NOTAS);
